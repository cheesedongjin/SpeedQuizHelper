(function(){
  ...
  const DEFAULT_CATEGORIES = [
    ...
    {name: "음료", icon: "🥤", words: [
      "물", "커피", "아메리카노", "카페라떼", "카푸치노", "에스프레소", "모카", "마키아토", "콜드브루", "프라푸치노",
      "녹차", "홍차", "우롱차", "허브차", "페퍼민트차", "캐모마일차", "얼그레이", "자스민차", "루이보스차", "히비스커스차",
      "밀크티", "버블티", "타로밀크티", "망고스茶", "레몬티", "아이스티", "복숭아아이스티", "유자차", "생강차", "대추차",
      "콜라", "사이다", "환타", "스프라이트", "닥터페퍼", "진저에일", "토닉워터", "루트비어", "크림소다", "에너지드링크",
      "오렌지주스", "사과주스", "포도주스", "망고주스", "파인애플주스", "토마토주스", "자몽주스", "크랜베리주스", "석류주스", "알로에주스",
      "우유", "초코우유", "딸기우유", "바나나우유", "두유", "아몬드밀크", "오트밀크", "코코넛밀크", "요거트드링크", "프로바이오틱스",
      "스무디", "녹즙", "케일주스", "셀러리주스", "비트주스", "당근주스", "떡볶이주스", "식혜", "수정과", "오미자차",
      "배즙", "사과식초", "레몬에이드", "라임에이드", "모히토", "상그리아", "콤부차", "스파클링워터", "미네랄워터", "보리차",
      "옥수수차", "둥글레차", "율무차", "메밀차", "보이차", "청차", "흑차", "백차", "매실주스", "매실차", "산사춘",
      "라떼아트", "디카페인커피", "헤이즐넛라떼", "바닐라라떼", "카라멜마키아토", "꿀레몬차", "생강레몬차", "녹차라떼", "초코라떼", "흑당라떼"
    ]},
    {name: "문구·사무용품", icon: "✍️", words: [
      "볼펜", "샤프펜슬", "연필", "만년필", "마커", "형광펜", "젤펜", "붓펜", "지우개", "수정테이프",
      "수정액", "자", "삼각자", "각도기", "컴퍼스", "분필", "화이트보드마커", "칠판지우개", "노트", "공책",
      "스프링노트", "메모지", "포스트잇", "스티커", "라벨지", "테이프", "투명테이프", "양면테이프", "마스킹테이프", "종이테이프",
      "가위", "커터칼", "문구칼", "스테이플러", "스테이플러심", "제거기", "클립", "종이클립", "바인더클립", "집게클립",
      "펀치", "파일철", "바인더", "폴더", "서류철", "서류봉투", "봉투", "편지봉투", "도장", "스탬프",
      "잉크패드", "풀", "딱풀", "액체풀", "글루건", "글루스틱", "테이프디스펜서", "종이컷터", "종이홀더", "명함홀더",
      "펜꽂이", "펜홀더", "책받침", "독서대", "북엔드", "문진", "탁상정리함", "서류함", "서류트레이", "칼날",
      "연필깎이", "전동연필깎이", "샤프심", "리필잉크", "종이테이프커터", "메모보드", "화이트보드", "코르크보드", "자석",
      "달력", "탁상달력", "일정표", "플래너", "다이어리", "스케줄러", "수첩", "주소록", "칼라종이", "오려내기종이",
      "스케치북", "드로잉북", "색종이", "종이접기", "스탬프북", "문구세트", "테이프커터", "서류가방", "서류파쇄기", "명찰"
    ]},
    {name: "소셜 미디어", icon: "📱", words: [
      "인스타그램", "페이스북", "유튜브", "틱톡", "트위터", "스냅챗", "링크드인", "핀터레스트", "위챗", "위보",
      "레딧", "텔레그램", "왓츠앱", "디스코드", "트위치", "텀블러", "카카오톡", "라인", "비고라이브", "스레드",
      "스토리", "릴스", "피드", "포스트", "트윗", "리트윗", "좋아요", "공유", "댓글", "팔로우",
      "팔로워", "해시태그", "DM", "다이렉트메시지", "스토리필터", "라이브", "스트리밍", "알고리즘", "탐색페이지", "바이럴",
      "인플루언서", "크리에이터", "밈", "짤", "트렌드", "챌린지", "릴", "쇼츠", "스티커", "필터",
      "그룹", "커뮤니티", "페이지", "프로필", "스토리하이라이트", "게시물", "타임라인", "릴스뷰", "인사이트", "애널리틱스",
      "스폰서", "광고", "부스트", "인스타스토리", "인스타라이브", "유튜브쇼츠", "틱톡챌린지", "트위터스페이스", "핀", "보드",
      "메신저", "그룹채팅", "비디오콜", "오디오콜", "스냅", "렌즈", "스포트라이트", "프렌즈", "채널", "구독",
      "알림", "푸시알림", "인기게시물", "탐라", "홈피드", "추천", "인스타광고", "유튜브프리미엄", "틱톡코인", "팔로잉",
      "소셜미디어", "온라인커뮤니티", "디지털마케팅", "소셜네트워크", "콘텐츠", "바이오", "프로필사진", "커버사진", "스토리링크", "스와이프업"
    ]},
